...
namespace BankingUnitTests.BonusCalculator
{
    ...
    {
        private readonly StandardBonusCalculator _bonusCalculator;
        ...
        public BonusCalculatorTests()
        {
            ...
            _bonusCalculator = new StandardBonusCalculator(stubbedClock.Object);
        }
            ...
            decimal expectedBonus)
        {
            ...
            decimal amountOfBonus = _bonusCalculator.GetBonusFor(
                balance,
                amountOfDeposit);
